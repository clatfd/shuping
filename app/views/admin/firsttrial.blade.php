...
<li class="active"><a href="firsttrial">初审</a></li>
...
{{ Form::open(array('url' => 'firsttrial')) }}
	<div class="row">
		...
		<div class="col-md-2 ">
			{{Form::select('trialresult', array('not' => '待审核', 'pass' => '通过', 'fail' => '不通过'), $ftr,array('class'=>'form-control'))}}
		</div>
		<div class="col-md-4">
