...
@foreach($queryrecords as $queryrecord)
	<tr>
		<td>{{$queryrecord->serialnum}}</td>
		<td>{{$queryrecord->name}}</td>
		<td>{{$queryrecord->studentid}}</td>
		<td>{{$queryrecord->firsttrial}}</td>
		<td>{{$queryrecord->trial}}</td>
		<td>{{$queryrecord->money}}</td>
	</tr>
@endforeach
		<tr>
			<td>1</td>
